    ...
    .then(([config, data]) => {
        ...
        function filterAndDisplayPokemon() {
            ...
            const filteredPokemon = allPokemon.filter(pokemon => {
                ...
                const hasMatchingHiddenAbility = pokemon.HiddenAbilities && 
                    pokemon.HiddenAbilities.toLowerCase().includes(abilityQuery);
...
function getBasePokemonData(pokemonData) {
    return {
        ...
        HiddenAbilities: pokemonData.HiddenAbilities,
...
function renderPokemonData(pokemon) {
    ...
    document.getElementById('pokemon-hidden-ability').textContent = pokemon.HiddenAbilities ? pokemon.HiddenAbilities : 'None';
...
function createPokemonCard(pokemon, basePokemon = null) {
    ...
    const hiddenAbilityText = pokemon.HiddenAbilities ? `Hidden Ability: ${pokemon.HiddenAbilities}` : "";
...
document.getElementById('pokemon-hidden-ability').textContent = pokemon.HiddenAbilities ? pokemon.HiddenAbilities.split(' - ')[0] : 'None';
